...
(function($) {
	         ...
	         /* -------------------------------------------------------------
		       3 - Typewriter Effect Controls Welcome to my Online Portfolio |

	         --------------------------------------------------------------- */
              $("#typing-effect").typed({
              strings: [ "Welcome","I'm Aboker Khalif", "I'm Software Developer"],//Change Page Heading Here
              typeSpeed: 30,
		      backSpeed: 30,
		      loop:true,
		      showCursor:false
...
function init() {
	...
	var mapOptions = {
		...
		center: new google.maps.LatLng(51.576750, 5.042947),	// Change to your latitude & longitude
	...
	var marker = new google.maps.Marker({
		position: new google.maps.LatLng(51.576750, 5.042947),	// Change to your latitude & longitude
		/* animation:google.maps.Animation.BOUNCE, Make the marker bounce */
		map: map,
		title: "Aboker Khalif"		// Change to your text
	});

	var infowindow = new google.maps.InfoWindow({
		content: "Aboker Khalif"		// Change to your text
	});
